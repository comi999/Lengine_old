...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  C:/Users/Glizz/Desktop/Programming/Miscellaneous Projects/Console-Game-Engine/ResourcePackager/Dependencies/build/test/gtest/src/gtest-stamp/gtest-configure-*.log")
  endif()
  ...
  if(NOT "Visual Studio 16 2019" MATCHES "Ninja")
    set(msg "gtest configure command succeeded.  See also C:/Users/Glizz/Desktop/Programming/Miscellaneous Projects/Console-Game-Engine/ResourcePackager/Dependencies/build/test/gtest/src/gtest-stamp/gtest-configure-*.log")
    message(STATUS "${msg}")
  endif()
endif()
